...
class Kubota_Connect {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Kubota_Connect_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'KUBOTA_CONNECT_VERSION' ) ) {
			$this->version = KUBOTA_CONNECT_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'kubota-connect';
	 ...
	 *
	 * - Kubota_Connect_Loader. Orchestrates the hooks of the plugin.
	...
	private function load_dependencies() {
		 ...
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-kubota-connect-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-kubota-connect-admin.php';
	 ...
	 *
	 * Uses the Kubota_Connect_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Kubota_Connect_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Kubota_Connect_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Kubota_Connect_Loader    Orchestrates the hooks of the plugin.
	 */
